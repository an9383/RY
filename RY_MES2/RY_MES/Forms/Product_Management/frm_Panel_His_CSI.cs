...
{
    public partial class frm_Panel_His_CSI : RY_MES.frm_Base
    {
        public frm_Panel_His_CSI()
        {
            InitializeComponent();
        }

        public frm_Panel_His_CSI(params object[] paramArray)
        {
            InitializeComponent();
        ...
        private void Get_Data_Grid1(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_IP_PANEL_HIS_CSI_LOAD", ref ds);
                ...
                if (string.IsNullOrEmpty(sMsg))
                {
                    ...
                    if (ucGridView2.Columns["REASON_CODE"] != null)
                    {
