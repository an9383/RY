...
{
    public partial class frm_OT_HIS : RY_MES.frm_Base
    {
        public frm_OT_HIS()
        {
            InitializeComponent();
        ...
        private void Get_Data_Grid()
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_OT_HIS_LOAD", ref ds);
                ...
                if (string.IsNullOrEmpty(sMsg))
                {
                    ...
                    ucGridView1.Set_Column_Type("시작일자", ucGridView.Col_Type.DateTime);
                    ucGridView1.Set_Column_Type("종료일자", ucGridView.Col_Type.DateTime);

                    ucGridView2.Set_Column_Type("시작일자", ucGridView.Col_Type.DateTime);
                    ucGridView2.Set_Column_Type("종료일자", ucGridView.Col_Type.DateTime);
