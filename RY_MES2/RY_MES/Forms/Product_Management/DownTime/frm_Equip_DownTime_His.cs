...
{
    public partial class frm_Equip_DownTime_His : RY_MES.frm_Base
    {
        public frm_Equip_DownTime_His()
        {
            InitializeComponent();
        }
        ...
        private void Get_Data_Grid(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_IP_EQUIP_DOWNTIME_HIS_LOAD", ref dt);
