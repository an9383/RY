...
{
    public partial class frm_Cell_DownTime_His : RY_MES.frm_Base
    {
        public frm_Cell_DownTime_His()
        {
            InitializeComponent();
        }
        ...
        private void Get_Data_Grid(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_IP_CELL_DOWNTIME_HIS_LOAD", ref dt);
                ...
                if (string.IsNullOrEmpty(sMsg))
                {
                    ...
                    view.MemoEdit_Column("REASON_NOTES");
                }
                else
                {
