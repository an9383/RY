...
{
    public partial class OQC_IOS_EzSensor_P : DevExpress.XtraReports.UI.XtraReport
    {
        private DataSet _ds;
        private frm_Base frm_Approval_Popup;

        public OQC_IOS_EzSensor_P(params object[] paramArray)
        {
            InitializeComponent();
            ...
            {
                lbl_ModelName.Text = "■ EzSensorP      □ EzSensor Pi";
