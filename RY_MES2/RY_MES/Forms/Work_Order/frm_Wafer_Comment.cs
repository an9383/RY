...
{
    public partial class frm_Wafer_Comment : RY_MES.frm_Base
    {
        public frm_Wafer_Comment()
        {
            InitializeComponent();
        }
        ...
        private void Get_Data_Grid(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("WO_WAFER_COMMENT_LOAD", ref dt);
                ...
                if (string.IsNullOrEmpty(sMsg))
                {
                    ...
                    view.Link_Column("DEFECT_ID", "frm_Defect_Monitoring_His");
                }
                else
                {
