...
{
    public partial class OQC_IOS_HDI2000 : DevExpress.XtraReports.UI.XtraReport
    {
        private DataSet _ds;
        private frm_Base frm_Approval_Popup;

        public OQC_IOS_HDI2000(params object[] paramArray)
        {
            InitializeComponent();
            ...
            if (qcDocID.Equals("230"))
            {
                lbl_Version.Text = "■1.5   □ 2.0";
            }
            else if (qcDocID.Equals("231"))
            {
                lbl_Version.Text = "□1.5   ■ 2.0";
            }
