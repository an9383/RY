...
{
    public partial class frm_Product_His_Time : RY_MES.frm_Base
    {
        public frm_Product_His_Time()
        {
            InitializeComponent();
        }
        ...
        private void Get_Data_Grid(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_IP_TIME_PRODUCT_HIS_LOAD", ref dt);

                if (string.IsNullOrEmpty(sMsg))
                {
                    grid.DataSource = dt;

                    view.Columns["PM_GROUP"].Caption = "품목군";

                    view.Columns["A"].Caption = "A (00:00 ~ 11:00)";
                    view.Columns["B"].Caption = "B (11:00 ~ 14:00)";
                    view.Columns["C"].Caption = "C (14:00 ~ 16:00)";
                    view.Columns["D"].Caption = "D (16:00 ~ 18:00)";
                    view.Columns["E"].Caption = "E (18:00 ~ 24:00)";
