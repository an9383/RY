...
{
    public partial class frm_Cell_Status_His_TFT : RY_MES.frm_Base
    {
        public frm_Cell_Status_His_TFT()
        {
            InitializeComponent();
        }
        ...
        private void Get_Data_Grid(ucGridControl grid)
        {
            ...
            try
            {
                ...
                string sMsg = _RYMES_DB.GET_DATA("PM_IP_CELL_STATUS_HIS_LOAD", ref dt);
