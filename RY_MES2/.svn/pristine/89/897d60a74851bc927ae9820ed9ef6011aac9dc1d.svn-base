...
{
    public partial class frm_OQC_DOC_Approval : RY_MES.frm_Base
    {
        private string _TEMPLATE_TYPE = "0002";

        public frm_OQC_DOC_Approval()
        {
            InitializeComponent();
        }
        ...
        private void Frm_Load(object sender, EventArgs e)
        {
            ...
            (gridControl.MainView as ucGridView).DoubleClick += gridView_DoubleClick;
        }
        ...
        //        frm_Approval_Popup popup = new frm_Approval_Popup(ticket_id, fa_id, template_type);
        ...
        {
            frm_Approval_Popup popup = new frm_Approval_Popup
            {
