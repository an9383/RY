...
using System.Linq;
using System.Web;
public partial class View_QC_CMOS_Report_OQC_IOS_HDI_DCA : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (qcDocID.Equals("222"))
        {
            ...
            if (rpt.FindControl("lbl_ModelName", true) != null)
                rpt.FindControl("lbl_ModelName", true).Text = "■ HDI-10DCA  □ HDI-20DCA";
            if (rpt.FindControl("lbl_Version", true) != null)
                rpt.FindControl("lbl_Version", true).Text = "■ 1.0    □ 2.0";
        }
