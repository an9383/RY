<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_CMOS_RunsheetList.aspx.cs" Inherits="View_QC_CMOS_Dashboard_CMOS_RunsheetList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
       ...
       function OpenPop_Runsheet() {      
            ...
            var url = "Report_QC_CMOS_REPORT.aspx?reportid=64" + urlParam;
