...
public partial class View_QC_CMOS_Report_OQC_IOS_EzSensor_P : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (qcDocID.Equals("226"))
        {
            if (rpt.FindControl("lbl_ModelName", true) != null)
                rpt.FindControl("lbl_ModelName", true).Text = "■ EzSensorP      □ EzSensor Pi";
            if (rpt.FindControl("lbl_Version", true) != null)
                rpt.FindControl("lbl_Version", true).Text = "■ 1.5   □ 2.0";
        }
        else if (qcDocID.Equals("227"))
        {
            if (rpt.FindControl("lbl_ModelName", true) != null)
                rpt.FindControl("lbl_ModelName", true).Text = "□ EzSensorP      ■ EzSensor Pi";
            if (rpt.FindControl("lbl_Version", true) != null)
        ...
        DataRow[] resolutions = _ds.Tables[1].Select("CHK_ID IN (1585, 1586)");
        ...
        DataRow[] sws = _ds.Tables[1].Select("CHK_ID IN (1587)");
        if (sws.Length > 0)
        {
