...
public partial class View_QC_CMOS_Report_OQC_IOS_HI2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (qcDocID.Equals("179"))
        {
            if (rpt.FindControl("lbl_ProductName", true) != null)
                rpt.FindControl("lbl_ProductName", true).Text = "□Medical  ■Veterinary" + rpt.FindControl("lbl_ProductName", true).Text;
            if (rpt.FindControl("lbl_ModelName1", true) != null)
                rpt.FindControl("lbl_ModelName1", true).Text = "■ IOS-U10VF  □ IOS-U15VF  □ IOS-U20VF";
        }
        ...
        {
            if (rpt.FindControl("lbl_ModelName1", true) != null)
                rpt.FindControl("lbl_ModelName1", true).Text = "□ HDI-15DGA ■ IOS-15DGA";
            if (rpt.FindControl("lbl_ModelName2", true) != null)
                rpt.FindControl("lbl_ModelName2", true).Text = "";
        }
