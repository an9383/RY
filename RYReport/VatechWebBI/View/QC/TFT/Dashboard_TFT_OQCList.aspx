<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dashboard_TFT_OQCList.aspx.cs" Inherits="View_QC_TFT_Dashboard_TFT_OQCList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function onDashboardTitleToolbarUpdated(sender, args) {
            ...
            addItem(items, "customReportIcon", OpenPop_OQC, "성적서 보기");
        ...
        function OpenPop_OQC() {      
            const arrKey = ['ContainerName', 'StepEntryTxnId', 'TEMPLATE_FORM'];
            ...
            $.each(axisPoint.GetDimensions(), function (_, dimension) {
                ...
                if (found != undefined) {
                    if (found == "TEMPLATE_FORM") {
                        formName = axisPoint.GetDimensionValue(dimension.Id).GetValue();
                    }
                    urlParam += "&" + found + "=" + axisPoint.GetDimensionValue(dimension.Id).GetValue();       
                }
            })
            
            var url = "Report_" + formName + ".aspx?reportid=" + urlParam;
...
<body style="padding-top: 4px;">
    ...
    <script src="../../../Scripts/GridHyperlinkOptionsExtension.js"></script>
</body>
</html>