<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMOS_BomByModel.aspx.cs" Inherits="View_Dashboard_CMOS_BomByModel" %>
    ...
    <script type="text/javascript">
        ...
        function onItemMasterFilterStateChanged(sender, args) {
            if (args.ItemName == "gridDashboardItem1") {
                ...
                var parameter1 = parameters.getParameterByName("pSapCode");
                parameter1.setValue(args.Values[0][3]);
            }
