    ...
    <script type="text/javascript">
        ...
        function OnLoginClick(s, e) {
            if (ASPxClientEdit.ValidateGroup('Login')) {
                cbPnlLogin.PerformCallback(devTheme);
            };
        }

        function CbPnlLogin_Init(s, e) {
            cboUserId.SetValue(getCookie("ry_loginid"));

            if (getCookie("ry_devTheme") == undefined) {
                setCookie("ry_devTheme", devTheme, 7);
            }
            ...
            if (s.cpLogin) {
                if (s.cpLogin == "true") {
                    if ($("#chkRemember").is(":checked")) {
                        setCookie("ry_loginid", cboUserId.GetValue(), 7);
                    };
            ...
            <div class="card-body">
                <div class="text-center m-t-0 m-b-15">
                    <a href="index.html" class="logo logo-admin">
                        <img src="../Images/rayence_logo.png" alt="" height="65" /></a>
                </div>
